...
Начинаем курс «Обучение на размеченных данных» от Яндекса. Рассчитываю закрыть [первую неделю](t.me/data_science_moscow/4624).

Если сегодня не доразберусь сама, то попробуем вместе понять, в чём была проблема с последним ассайнментом (см. [чат](t.me/data_science_moscow/4634)).
